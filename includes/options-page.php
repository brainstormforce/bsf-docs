...
<div class="wrap">
	<div class="bsf-options-form-wrap clearfix">
		...
		<h1><?php _e( "Docs Settings", "documentation-wordpress" ); ?></h1>
					...
					<table  class="form-table">
				        <tr valign="top">
					        ...
					        <td>
					        	...
					        	$checked = ( $bsf_ls_enabled === false ) ? " checked='checked' " : ( ( $bsf_ls_enabled == 1 ) ? " checked='checked' " : "" );
					        	?>
					        ...
					        <td>	
					        	<fieldset>
									...
									foreach ( $post_types as $key => $post_type ) { ?>
										...
										<input type="checkbox" <?php if( in_array( $key, $selected_post_types ) ) { echo "checked='checked' "; } ?> name="bsf_search_post_types[]" value="<?php echo esc_attr( $key ); ?>" />
										<label>
				        ...
				        <tr valign="top">
					        ...
					        <td>
					        	...
					        	$checked = ( $bsf_override_single_template === false ) ? " checked='checked' " : ( ( $bsf_override_single_template == 1 ) ? " checked='checked' " : "" );
					        	?>
				        ...
				        <tr valign="top">
					        ...
					        <td>
					        	...
					        	$checked = ( $bsf_override_category_template === false ) ? " checked='checked' " : ( ( $bsf_override_category_template == 1 ) ? " checked='checked' " : "" );
					        	?>
				        ...
				        <tr valign="top">
					        ...
					        <td>
					        	...
					        	$checked = ( $bsf_search_has_comments === false ) ? " checked='checked' " : ( ( $bsf_search_has_comments == 1 ) ? " checked='checked' " : "" );
				 ...
				 <tr valign="top">
				    ...
				    <td>
				   		<div class="bsf-shortcode-container wp-ui-text-highlight">
				   			[wp_docs_live_search placeholder="Have a question? Enter a search term."]
				   		</div>  
				    </td>
				</tr>
				<tr valign="top">
